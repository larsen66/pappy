...
from user_profile.models import SellerProfile, SpecialistProfile, VerificationDocument, Review
...
class ProfilePermissionsTests(TestCase):
    def setUp(self):
        ...
        # Create specialist profile with all required fields
        self.specialist_profile = SpecialistProfile.objects.create(
            user=self.user,
            specialization='veterinarian',
            experience_years=5,  # Add this required field
            services='Test services'
        )
