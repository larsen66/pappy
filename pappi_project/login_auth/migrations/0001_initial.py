    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sms_code', models.CharField(blank=True, max_length=4, null=True, verbose_name='SMS код')),
                ('sms_code_expires', models.DateTimeField(blank=True, null=True, verbose_name='Срок действия кода')),
